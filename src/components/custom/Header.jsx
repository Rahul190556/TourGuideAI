    ...
    <div className="header bg-gradient-to-b from-white-300 via-white-100 to-white text-black">
      <div className="header-content p-3 shadow-sm flex justify-between items-center px-5">
        ...
        <img
          ...
          className="logo max-w-[8%] h-auto max-h-[30%] ml-1 bg-blue rounded-lg -mt-4 shadow-none"
          onClick={handleHomeClick} // Add onClick to the logo for redirection
        />
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            ...
            <button
              ...
              className="bg-black text-white border-none py-2 px-4 text-lg cursor-pointer transition ease-in-out duration-300 mr-10 rounded-lg hover:bg-white hover:text-black"
            >
              Sign In
            </button>
